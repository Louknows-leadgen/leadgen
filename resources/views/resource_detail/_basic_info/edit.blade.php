<form class="update" action="{{ route('rd.update_person',['person_id'=>$person->id]) }}">
	...
	<div class="dtl-cntr">
		...
		<input type="text" name="civil_status" class="form-control" value="{{ $person->civil_status }}">
		<select name="gender" class="custom-select">
	...
	<div class="dtl-cntr">
		...
		<input type="text" name="birthday" class="form-control date" value="{{ $person->birthday }}">
	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group d-flex justify-content-end">
				<span class="btn btn-secondary j_abort" data-tab="basic" data-id="{{ $person->id }}">Cancel</span>
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group">
